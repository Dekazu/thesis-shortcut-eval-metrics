...
def get_args():
    ...
    parser.add_argument('--config_files',
                        default=[
                            ## Band-aid
                            # "config_files/real_artifacts_clarc/isic/local/vgg16_band_aid_RRClarc_lamb100000000_svm_cavs_max_sgd_lr0.0005_features.28.yaml",
                            # "config_files/real_artifacts_clarc/isic/local/vgg16_band_aid_RRClarc_lamb100000000_signal_cavs_max_sgd_lr0.0005_features.28.yaml"
                            #                                                vgg16_band_aid_RRClarc_lamb100000000_signal_cavs_max_sgd_lr0.0005_features.28

                            ## Skin-marker
                            "config_files/real_artifacts_clarc/isic/local/vgg16_skin_marker_RRClarc_lamb100000000_svm_cavs_max_sgd_lr0.0005_features.28.yaml",
                            "config_files/real_artifacts_clarc/isic/local/vgg16_skin_marker_RRClarc_lamb100000000_signal_cavs_max_sgd_lr0.0005_features.28.yaml"


                            ## Ruler
                            # "config_files/real_artifacts_clarc/isic/local/vgg16_ruler_RRClarc_lamb50000000_svm_cavs_max_sgd_lr0.0005_features.28.yaml",
                            # "config_files/real_artifacts_clarc/isic/local/vgg16_ruler_RRClarc_lamb50000000_signal_cavs_max_sgd_lr0.0005_features.28.yaml"
                            ]
                            )
...
def plot_corrected_model(configs):
    ...
    for ckpt_path_corrected, config in zip(ckpt_paths_corrected, configs):
        model_corrected = get_fn_model_loader(model_name=configs[0]['model_name'])(n_class=len(dataset.classes),
    ...
    model_original = get_fn_model_loader(model_name=configs[0]['model_name'])(n_class=len(dataset.classes),
