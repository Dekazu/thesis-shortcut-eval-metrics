...
def get_args():
    ...
    parser.add_argument('--config_file',
                        default="config_files/clarc/isic_attacked/local/vgg16_Vanilla_sgd_lr0.0005_features.28.yaml")
    parser.add_argument('--crp_file_dir', default="/Users/rustler/Documents/Projects/bachelor-thesis/crp-files")
