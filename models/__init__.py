...
from models.convnext import get_convnext_small, get_convnext_tiny, get_convnext_base, get_convnext_large, get_convnext_canonizer
...
CANONIZERS = {
    ...
    "convnext_tiny": get_convnext_canonizer,
    "convnext_small": get_convnext_canonizer,
    "convnext_base": get_convnext_canonizer,
    "convnext_large": get_convnext_canonizer,
