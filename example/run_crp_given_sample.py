...
def get_parser():
    ...
    parser.add_argument("--sample_ids", 
                        default="531,547,527,541", type=str) # ISIC2024 band-aid 
    parser.add_argument("--max_mode", default="relevance", type=str)
    parser.add_argument("--split", default="all", type=str)
    parser.add_argument("--n_concepts", default=5, type=int)
    parser.add_argument("--n_refimgs", default=6, type=int)
    parser.add_argument("--config_file", 
                        default="example/configs/resnet50d_last_conv.yaml")
    parser.add_argument('--savedir', default='outputs/crp_plots/')
    return parser
