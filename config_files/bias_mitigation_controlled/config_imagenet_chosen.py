...
with open("config_files/chosen_model_params_corrected.json", "r") as stream:
    chosen_model_params_corrected = json.load(stream)["imagenet_attacked"]
...
for model_name, layer_names in [
    ...
    for p_artifact in p_artifact_rates:
        for layer_name in layer_names:
            ...
            lamb, epoch = chosen_model_params_corrected[model_name][str(p_artifact)]
            ...
            config_name = f"imagenet_attacked_{artifact_type_dog}_{model_name}_{method}_{optim_name}_lr{lr}_ep{epoch}_p_artifact{p_artifact}_{layer_name}"
            store_local(config_dog, config_name, artifact_type_dog)
            store_cluster(config_dog, config_name, artifact_type_dog)
