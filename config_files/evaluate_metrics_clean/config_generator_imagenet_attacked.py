...
config_dir = "config_files/evaluate_metrics_clean/imagenet_attacked"
...
for model_name, layer_names in [
    ...
    for p_artifact in p_artifact_rates:
        for layer_name in layer_names:
            ...
            config_name = f"imagenet_attacked_{artifact_type_dog}_{model_name}_p_artifact{p_artifact}_{layer_name}_baseline"
            ...
            config_name = f"imagenet_attacked_{artifact_type_frog}_{model_name}_p_artifact{p_artifact}_{layer_name}_baseline"
