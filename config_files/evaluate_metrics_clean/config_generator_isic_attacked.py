...
config_dir = "config_files/evaluate_metrics_clean/isic_attacked"
...
for model_name, layer_names in [
    ...
    for p_artifact, p_artifact_na in p_artifact_rates:
        ...
        for layer_name in layer_names:
            ...
            config_name = f"isic_attacked_{model_name}_p_artifact{p_artifact}_p_artifact_na{p_artifact_na}_{layer_name}_baseline"
