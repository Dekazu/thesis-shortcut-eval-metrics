...
config_dir = "config_files/evaluate_metrics_clean/waterbirds"
...
for model_name, layer_names in [
    ...
    for p_artifact_landbirds, p_artifact_waterbirds in p_artifact_rates:
        ...
        for layer_name in layer_names:
            ...
            ## Baseline Attacked
            config_attacked= copy.deepcopy(base_config)
            method = 'Vanilla'
            config_attacked["direction_mode"] = "signal"
            config_attacked["cav_mode"] = "cavs_max"
            config_attacked["cav_scope"] = None
            config_attacked['method'] = method
            config_attacked['lamb'] = 0.0
            config_attacked['num_epochs'] = 0
            config_attacked['p_artifact_landbirds'] = p_artifact_landbirds
            config_attacked['p_artifact_waterbirds'] = p_artifact_waterbirds
            config_name = f"waterbirds_{model_name}_p_artifact_landbirds{p_artifact_landbirds}_p_artifact_waterbirds{p_artifact_waterbirds}_{layer_name}_baseline"
            store_local(config_attacked, config_name)
            store_cluster(config_attacked, config_name)