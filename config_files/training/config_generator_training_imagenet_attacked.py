...
config_dir = "config_files/training/imagenet_attacked"
...
for artifact_type in ['bone']: # 'bone', 'ch_time'
    ...
    if artifact_type == "bone":
        base_config['attacked_classes'] = ['Dog']
    elif artifact_type == "lsb":
        base_config['lsb_trigger'] = lsb_trigger
        base_config['lsb_factor'] = 4
        base_config['attacked_classes'] = ['Frog']
    ...
    for model_name in [
        ...
        for p_artifact in p_artifact_rates:
            for p_backdoor in [
                0.5, 0.25, 0.1, 0.05, 0.025, 0.01, 0.005, 0.0025, 0.001, 0.0005, 0.00025, 0.0001, 0.00005, 0.000025, 0.00001,
                ]:
                ...
                for lr in lrs:
                    ...
                    for optim_name in optims:
                        ...
                        config_name = f"imagenet_attacked_{artifact_type}_{model_name}_{optim_name}_lr{lr}_p_artifact{p_artifact}_p_backdoor{p_backdoor}"
